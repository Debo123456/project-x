    ...
    <form action="{{url('/'. str_replace(" ", "-", Auth::user()->name). "/".'update-car/'.$car->id)}}" class="form col-xs-10 col-sm-8 col-md-5" method="post" enctype="multipart/form-data">
      ...
      @elseif (session('info'))
        <div class=" alert alert-warning">
          <strong>Uh oh!!</strong> {{ session('info')}} .
        </div>
      @elseif (count($errors))
      ...
      @else
        <p style="text-align:center;">Edit only the fields you wish to update.</p>
      @endif

      <div id="make-container" class="{{ $errors->has('make') ? ' has-error' : '' }}">
        <label for="make">Make</label>
        <select name="make" id="make" class="form-control" value="{{ $car->make }}">
          <option>Any</option>
          <option>Acura</option>
          <option>Audi</option>
          <option>BMW</option>
      ...
      <div id="model-container" class="{{ $errors->has('model') ? ' has-error' : '' }}">
        <label for="model">Model</label>
        <select name="model" id="model" class="form-control" value="{{ $car->model }}" >
      ...
      <div class="{{ $errors->has('year') ? ' has-error' : '' }}">
        ...
        <select name="year" id="min_year" class="form-control" value="{{ $car->year }}">
          <option>Any</option>
          <?php
          for($i=2017; $i>1970; $i--)
          {
      ...
      <div class="{{ $errors->has('condition') ? ' has-error' : '' }}">
        ...
        <select name="condition" id="condition" class="form-control" value="{{ $car->condition }}">
          <option>Any</option>
          <option>New</option>
          <option>Used</option>
      ...
      <div class=" {{ $errors->has('price') ? ' has-error' : '' }}">
        ...
        <div class="flex price-input" data-toggle="tooltip" data-placement="left" title="Set your vehicles selling price">
          ...
          <input  id="price" class="form-control" type="text" name="price" maxlength="15">
      ...
      <div class="{{ $errors->has('location') ? ' has-error' : '' }}" style="clear: both;">
        ...
        <div class="inline-elements">
          <input id="town-city" class="form-control" type="text" name="town-city" value="{{ old('town-city') }}" placeholder="City/Town" />
          <br/>
          <select name="parish" id="parish" class="form-control" value="{{ old('parish') }}">
      ...
      <div id="phone-input" class=" has-feedback" data-toggle="tooltip" data-placement="left" title="Enter your phone number in the format: (876)-123-4567">
        ...
        <input id="phone" class="form-control" name="phone" type="text" value="" aria-describedby="inputSuccess2Status" placeholder="Enter phone number." data-mask="(000) 000-0000"/>
      ...
      <div class="{{ $errors->has('transmission') ? ' has-error' : '' }}">
        <label for="transmission">Transmission</label>
        <select name="transmission" id="transmission" class="form-control" value="{{ $car->condition }}" >
          <option>Any</option>
      ...
      <div class="{{ $errors->has('body_type') ? ' has-error' : '' }}">
        ...
        <select name="body_type" id="body_type" class="form-control" value="{{ $car->body_type }}" >
          <option>Any</option>
          <option>Sedan</option>
          <option>Coupe</option>
          <option>Hatch</option>
      ...
      <div class="{{ $errors->has('description') ? ' has-error' : '' }}">
        ...
        <textarea class="form-control" name="description" rows="5" value="{{ $car->description }}"></textarea>
